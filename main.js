...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _app_services_translate_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../app/services/translate.service */ "./src/app/services/translate.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _app_services_translate_service__WEBPACK_IMPORTED_MODULE_2__["TranslateService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _app_services_translate_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../app/services/translate.service */ "./src/app/services/translate.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_19__["ModalModule"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_21__["CookieService"], _app_services_translate_service__WEBPACK_IMPORTED_MODULE_22__["TranslateService"]],
...
var ContentpageComponent = /** @class */ (function () {
    ...
    ContentpageComponent.prototype.ngOnInit = function () {
        ...
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            _this.hideDistanceServiceType = !_this.hideDistanceServiceType;
            _this.seeCompleteList = _environments_environment__WEBPACK_IMPORTED_MODULE_10__["globals"].TitleSeeCompleteList;
        });
        this.dropdownSettings = {
    ...
    ContentpageComponent.prototype.onDropdownChange = function (country) {
        ...
        for (var i = 0; i < this.filteredCountryDetails.length; i++) {
            ...
            if (this.filteredStates) {
                var states = this.filteredStates.sort(function (a, b) { return a.name.localeCompare(b.name); });
    ...
    ContentpageComponent.prototype.onItemSelectAllServices = function (items) {
        ...
        items.forEach(function (element) {
            _this.selectedServiceIds.push(element);
        });
        ...
        if (this.selectedFilterStatesIds.length > 0) {
            ...
            for (var i = 0; i < result.length; i++) {
                if (result[i].length > 0) {
                    ...
                    if (this.filterdCities) {
                        var cities = this.filterdCities.sort(function (a, b) { return a.name.localeCompare(b.name); });
                        this.filterdCities = Array.from(new Set(cities));
                    }
                }
            }
    ...
    ContentpageComponent.prototype.toggleFilter = function (type) {
        if (type === 'Search') {
            ...
            if (!(this.userLoclat && this.userLoclng && this.dataFilter.userLat && this.dataFilter.userLong)) {
                this.hideDistanceServiceType = true;
            }
            this.sendMessage(this.dataFilter);
        }
    ...
    ContentpageComponent.prototype.clearSearchfields = function () {
        this.setDefaultDistance();
    };
    ContentpageComponent.prototype.setDefaultDistance = function () {
        this.advSearchDistance = 1;
    };
...
var DealerlistComponent = /** @class */ (function () {
    ...
    DealerlistComponent.prototype.getFiltersFromContent = function () {
        ...
        this.subscription = this._dataService.getMessage().subscribe(function (message) {
            _this.filterargs = message.text;
            if (_this.dealerCompleteArray.length !== 0) {
                _this.spinnerService.show();
                _this.dealerCompleteArray.forEach(function (element) {
    ...
    DealerlistComponent.prototype.filterBracketsPhoneMobileFax = function (list) {
        var result = [];
        list.forEach(function (element) {
            element.phone = element.phone.replace('()', '');
            element.mobile = element.mobile.replace('()', '');
            element.fax = element.fax.replace('()', '');
            result.push(element);
        });
        return result;
    };
        ...
        if (this.currentLocation.lat && this.currentLocation.lng) {
            locations.map(function (location) {
                ...
                if (placeLocation.lat !== 0 && placeLocation.lng !== 0) {
                    location.distance = _this.getDistanceBetweenPoints(_this.currentLocation.lat, _this.currentLocation.lng, placeLocation, 'miles').toFixed(1);
                }
            });
    ...
    DealerlistComponent.prototype.getTimezone = function (lat, long) {
        //var apiKey = 'AIzaSyAQIM4bPOWHTrGjbad_TBHMTld7txdtuew'
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(modalService, spinnerService, cookieService, translate) {
        this.modalService = modalService;
        this.spinnerService = spinnerService;
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        var value = this.cookieService.get('cookieAccepted');
        if (value !== 'true') {
            this.cookieAccepted = false;
        }
        else {
    ...
    HeaderComponent.prototype.setLang = function (languageCode) {
        this.translate.use(languageCode).then(function (tr) {
            //globals.TitleSeeCompleteList = tr.TitleSeeCompleteList;
        });
    };
    ...
    HeaderComponent.prototype.openAndroid = function () {
        if (navigator.userAgent.match(/android/i)) {
            ...
            window.location.href = 'https://itunes.apple.com/us/app/containerlink/id1387492814';
            var win = window.open(androidLink, '_blank');
            win.focus();
        }
        else {
    ...
    HeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_node_modules_ngx_bootstrap__WEBPACK_IMPORTED_MODULE_2__["BsModalService"], ng4_loading_spinner__WEBPACK_IMPORTED_MODULE_1__["Ng4LoadingSpinnerService"],
            ngx_cookie_service__WEBPACK_IMPORTED_MODULE_3__["CookieService"], _services_translate_service__WEBPACK_IMPORTED_MODULE_4__["TranslateService"]])
    ], HeaderComponent);
...
var TranslateService = /** @class */ (function () {
    ...
    TranslateService.prototype.use = function (lang) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            return _this.http.get(langPath).subscribe(function (translation) {
